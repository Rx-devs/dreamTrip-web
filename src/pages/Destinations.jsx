  ...
  return (
    <div className="py-10 container mx-auto text-center">
      <div className="flex flex-col gap-4 w-3/4 lg:w-1/2 mx-auto">
        <p className="text-4xl md:text-5xl font-semibold typography-heading">
          All Destinations
        </p>
        <p>
          Explore top desntinations to choose your next travel destination. We
          keep traveling and searching for new things to do, we are focused on
          travel.
        </p>
      </div>
