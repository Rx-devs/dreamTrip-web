...
const DestinationDetails = () => {
  ...
  const { isLoading, data, isError, error, isSuccess } =
    useDestinationData(destinationId);
  const TourInfo = [
    {
      info: "Destination",
        ...
        <>
          ...
          >
            ...
            <div className="absolute top-2/4 left-1/2 -translate-x-1/2 -translate-y-2/4 z-20 text-white">
              <span className="block text-3xl text-center typography-caption">
                Amazing Tour
              </span>
            ...
            <div className="space-y-10 pb-10">
              <div className="">
                <div className="flex items-center gap-3 mb-2">
                  <h3 className="text-3xl font-medium">
                    {data?.destination_name} Trip
                  </h3>
                  <p>
                    <span>{data.travel_cost}</span>/ per person
                  </p>
                </div>
              ...
              <div>
                <ul className="space-y-6">
                  {TourInfo.map((tour) => (
                    <li className="flex w-full" key={tour.info}>
                ...
                <div className=" w-full">
                  <form className="space-y-6" action="#" method="POST">
                    <div className="rounded-md shadow-sm  space-y-4">
                      ...
                      <div>
                        <label htmlFor="tickets" className="sr-only">
                          Tickets
                        </label>
                        <input
                          id="tickets"
