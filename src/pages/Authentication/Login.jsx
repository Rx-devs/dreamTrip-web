    ...
    <div className="overflow-hidden">
      <div className="bg-white sm:bg-gray-200 py-6 md:py-10 w-screen flex flex-col justify-center items-center">
        <div className="relative bg-white shadow-none sm:shadow-lg px-8 sm:px-12 w-full xs:w-full sm:w-6/12 md:w-5/12 lg:w-4/12 xl:w-2/6 h-screen sm:h-auto py-4">
          <div
            ref={modalRef}
            className="mt-10 absolute z-10 top-0 left-0 mx-6 hidden"
          >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="w-full flex gap-0">
              <button
                ...
                className="bg-red-500 text-white w-full px-2 py-3 flex flex-row justify-center gap-2 items-center hover:bg-red-600 duration-100 ease-in-out"
              >
                Google
              </button>
              <button
                disabled
                onClick={handleGoogleSignIn}
                className="bg-blue-500 text-white w-full px-2 py-3 flex flex-row justify-center gap-2 items-center hover:bg-blue-600 duration-100 ease-in-out"
              >
                Facebook
              </button>
            </div>
            ...
            <div className="my-2 text-center">
              ...
              <Link to="/register">
                <span className="color-main font-medium"> Join here </span>
              </Link>
            </div>
          </div>
        </div>
