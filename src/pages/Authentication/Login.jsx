          ...
          <div className="relative bg-white shadow-none sm:shadow-lg px-8 sm:px-12 w-full xs:w-full sm:w-6/12 md:w-5/12 lg:w-4/12 xl:w-2/6 h-screen sm:h-auto py-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="w-full flex gap-0">
                ...
                <button disabled onClick={handleGoogleSignIn} className="bg-blue-500 text-white w-full px-2 py-3 flex flex-row justify-center gap-2 items-center hover:bg-blue-600 duration-100 ease-in-out">
                  Facebook
                </button>
              </div>
